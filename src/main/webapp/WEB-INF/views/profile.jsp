			...
			<div class="span6">
				<form class="form-horizontal">
					...
					<div class="control-group">
						...
						<div class="controls">
							<span class="uneditable-input input-large">${profile.url}</span>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<span class="uneditable-input input-large">${profile.screenName}</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Last Name:</label>
						<div class="controls">
							<span class="uneditable-input input-large">${profile.city}</span>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<span class="uneditable-input input-large">${profile.location}</span>
						</div>
					</div>
				</form>
			</div>
